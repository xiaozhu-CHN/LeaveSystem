...
<script type="text/javascript">
		function pages(id)
		{
			location.href="/LeaveSystem/leave/teacher/college/limitleave?button="+id;
		}
		function allfake()
		{
		...
		{
			location.href="/LeaveSystem/leave/teacher/college/ToBeAudited";
		}
		function ToBeASoldOff()
		{
			location.href="/LeaveSystem/leave/teacher/college/ToBeASoldOff";
		}
		function Adopt()
		{
			location.href="/LeaveSystem/leave/teacher/college/Adopt";
		}
		function NoAdopt()
		{
			location.href="/LeaveSystem/leave/teacher/college/NoAdopt";
		}
		function AlreadySoldOff()
		{
			location.href="/LeaveSystem/leave/teacher/college/AlreadySoldOff";
		}
		function adopt(leave)
		{
			if(confirm('审核通过？')){
			location.href="/LeaveSystem/leave/teacher/college/examine?dbteacherleave.id="+leave+"&dbteacherleave.xyldState=2";
			}
		}
		function noadopt(leave)
		{
			var t=prompt("不通过理由（100字以内）","学院领导审核不通过理由：")
			  if (t!=null && t!="")
			    {
				  location.href="/LeaveSystem/leave/teacher/college/examine?dbteacherleave.id="+leave+"&dbteacherleave.xyldState=3&dbteacherleave.remarks="+t;
			    }
		}
		function CollegeExit()
		{
			location.href="/LeaveSystem/leave/teacher/college/CollegeExit";
		}
		function executeDownLoad()
		{
			location.href="/LeaveSystem/leave/teacher/college/executeDownLoad";
		}
		function TeacherEclass()
		{
			location.href="/LeaveSystem/leave/teacher/college/TeacherEclass";
		}
</script>
...
<body>
	...
	<input type='button' value='退出系统' onclick="CollegeExit()" align="right"><br/>
	</div>
	<div align="center">
	<table>
	<tr>
		<td>
		<form action="/LeaveSystem/leave/teacher/college/LeaveStudent" method="post">
		学号：<input type="text" name="dbteacherleave.student" placeholder="输入学号进行查询！" pattern="[0-9]{9}">
		<input type="submit" value="查询">
		</form>
		</td>
		<td>
		<form action="/LeaveSystem/leave/teacher/college/LeaveId" method="post">
		请假编号：<input type="text" name="dbteacherleave.id" placeholder="输入请假编号进行查询！" pattern="^[0-9]*$">
		<input type="submit" value="查询">
		</form>
		</td>
		<td>
		<form action="/LeaveSystem/leave/teacher/college/LeaveName" method="post">
	...
	<table align="center">
		<tr>
			...
			<td><input type='button' value='学院班级管理' onclick="TeacherEclass()"></td>
		</tr>	 
	</table>
	...
	<table align="center" width="100%" height="100%">
		...
		<td align="center"><c:if test="${jiatiao.xyldState==1}" >
