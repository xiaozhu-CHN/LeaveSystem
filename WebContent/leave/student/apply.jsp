...
<a href="/LeaveSystem/leave/student/stdentLoginLeave" >返回主页</a>
<form  action="/LeaveSystem/leave/student/applyLeave" method="post"  >
	<table align="center">
		<tr>
		...
		<tr>
				<td align="right"><input type="submit" value="申请请假" ></td>					
